...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                @if($perfil->imagen)
                <img src="/recetaslaravel/storage/app/public/{{$perfil->imagen}}" class="w-100 rounded-circle" alt="imagen chef">
                @endif
            </div>
            ...
            @if(count($recetas) > 0)
                @foreach($recetas as $receta)
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="/recetaslaravel/storage/app/public/{{$receta->imagen}}" class="card-img-top" alt="imagen receta">
                            <div class="card-body">
                                <h3>{{$receta->titulo}}</h3>
